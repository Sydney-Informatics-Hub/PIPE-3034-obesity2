...
```{r}
chisq_instances_wc_normalised(overweight_annotated_filtered, metadata_full, source_type)
```
...
```{r}
chisq_articles_totalart_normalised(overweight_annotated_filtered, metadata_full, source_type)
```
...
```{r}
chisq_instances_wc_normalised(overweight_annotated_filtered, metadata_full, orientation)
```
...
```{r}
chisq_articles_totalart_normalised(overweight_annotated_filtered, metadata_full, orientation)
```
