...
4. Significant differences in the use of "overweight" were observed in articles on different topics, with articles annotated as "Biomedical Research", "Women and Pregnancy" and "Children & Parents" using more instances per 1000 words than articles discussing "Politics", schooling and "Music and Movies". 
...
We can see that there are differences in the  frequency of use of the word "overweight" by topic, with articles annotated as "Biomedical Research", "Children and Parents" using more instances per 1000 words than articles discussing politics, schooling, transport and commuting.
